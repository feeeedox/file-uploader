...
export const buttonStyles = tv({
  ...
  variants: {
    ...
    effect: {
      ...
      gradientRainbow:
        "animate-gradient-flow bg-[linear-gradient(90deg,var(--gradient-lime),var(--gradient-ocean),var(--gradient-wine),var(--gradient-rust))] bg-size-[400%] text-white",
      gradientGreen:
        "animate-gradient-flow bg-[linear-gradient(-45deg,var(--gradient-lime),var(--gradient-emerald),var(--gradient-green))] bg-size-[400%] text-white",
    },
    size: {
